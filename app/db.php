...
function create_tables(PDO $pdo): void {
    $pdo->exec("
        CREATE TABLE IF NOT EXISTS phases (
            ...
            date       VARCHAR(12) NOT NULL DEFAULT '2026-08-09',
...
function seed_data(PDO $pdo): void {
    ...
    $sp = $pdo->prepare("INSERT IGNORE INTO phases (id,emoji,label,date,sort_order) VALUES (?,?,?,?,?)");
    ...
    $si = $pdo->prepare("INSERT IGNORE INTO items
    ...
    $sc = $pdo->prepare("INSERT IGNORE INTO corsages (id,name,role,is_done,sort_order) VALUES (?,?,?,0,?)");
